...
hist(x1, probability = TRUE, main = "theta=1")
...
theta2 <- 2
x2 <- rg(theta2, n)
hist(x2, probability = TRUE, main = "theta=2")
...
hist(x1, probability = TRUE, main = "theta=1, beta=2")
points(density(x1), type = "l")

theta2  <- 2
beta2 <- 1
x2 <- rf(theta2, beta2, 10000)
hist(x2, probability = TRUE, main = "theta=2, beta=1")
points(density(x2), type = "l")
```
